...
#' ---
#' title: "Asocjacje"
#' author: "Karolina Kuligowska (eksportował Jan Muchorowski)"
#' date:   " 12.05.2025"
#' output:
#'   html_document:
#'     df_print: paged
...
# Wytypowane słowo 1 i próg asocjacji
target_word <- "crews"
cor_limit <- 0.4
...
# Wytypowane słowo 2 i próg asocjacji
target_word <- "service"
cor_limit <- 0.4
...
# Wytypowane słowo 3 i próg asocjacji
target_word <- "attendants"
cor_limit <- 0.4
